 ...
 *
 * VARIANT v2 (synthetic-chunk-v2.js): the checksum also adds the path length
 * mod 7, a formula change the constants scheme cannot express. Extraction
 * must fall back to "delegated" mode and sign with the function itself.
 */
...
(self.webpackChunkof_vue=self.webpackChunkof_vue||[]).push([[9999],{
    ...
    109999:function(m,e,t){
        ...
        e.A=function(r){
            ...
            var sum=[1,1,5,9,22,39].reduce(function(a,i){return a+sha[i].charCodeAt(0)},0)-77+url.length%7;
